...
urlpatterns = [
    ...
    # food
    # =================api=========================================================================
    path('api/food/', views.get_foods),
    path('api/food/<str:pk>/', views.get_food),
    path('api/add-food/', views.add_food),
    path('api/food/<str:pk>/update/', views.update_food),
    path('api/food/<str:pk>/delete/', views.delete_food),


    # offers 
    path('api/offers/', views.offers),
    path('api/offer/<str:pk>/', views.offer),
    path('api/admin-dash/', views.adm_dashboard),
